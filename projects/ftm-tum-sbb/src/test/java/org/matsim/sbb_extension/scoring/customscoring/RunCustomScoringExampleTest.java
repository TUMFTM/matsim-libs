package org.matsim.sbb_extension.scoring.customscoring;
...
import org.matsim.sbb_extension.RunAbcSimpleExample;
...
public class RunCustomScoringExampleTest{
	private static final Logger log = LogManager.getLogger( RunCustomScoringExampleTest.class ) ;
	...
	public void testMain(){
		try{
			RunCustomScoringExample.main( new String []{ IOUtils.extendUrl( ExamplesUtils.getTestScenarioURL( "equil" ), "config.xml" ).toString()
